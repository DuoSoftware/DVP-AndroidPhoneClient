...
import apps.veery.com.services.PortSipService.MyBinder;
import apps.veery.com.util.Line;
import apps.veery.com.util.Network;
import apps.veery.com.util.Session;
import apps.veery.com.util.SettingConfig;
import apps.veery.com.util.SipContact;
...
import apps.veery.com.services.PortSipService;
...
//		Notification notification = new Notification(R.drawable.ic_launcher, "Sip Notify!", System.currentTimeMillis());
...
//		nm.notify(1, notification);
    ...
    public void setpDialog(SweetAlertDialog pDialog) {
...
//            }
    ...
    public void onRegisterSuccess(String reason, int code) {
        Toast.makeText(MyApplication.this, "Register sucsess", Toast.LENGTH_SHORT).show();
        brignToDash();
        _SIPOnline = true;
        _SIPLogined=true;
        if (mainActivity != null) {
...
//			}
    ...
    public void onRegisterFailure(String reason, int code) {
        Toast.makeText(MyApplication.this, "Register Fail", Toast.LENGTH_SHORT).show();
        _SIPOnline = false;
...
//			}
    ...
    public void onInviteIncoming(long sessionId, String callerDisplayName, String caller,
                                 ...
                                 boolean existsVideo) {
        Toast.makeText(MyApplication.this, "Inside InviteIncoming", Toast.LENGTH_SHORT).show();
...
//            AlertDialog alertDialog = new AlertDialog.Builder(new DashActivity()).create();
//            alertDialog.setTitle("Incoming Video Call");
//            alertDialog.setMessage(comingCallTips);
            Toast.makeText(MyApplication.this, "Video CALL " + comingCallTips, Toast.LENGTH_SHORT).show();
...
//            alertDialog.setMessage(comingCallTips);
//
//            Toast.makeText(MyApplication.this, "AAA Incoming Audio Call  " + comingCallTips, Toast.LENGTH_SHORT).show();
//            answerSessionCall(curSession,false);
...
//        testNotification();
        setCaller(caller);
//        final Line curSession = tempSession;
//        answerSessionCall(tempSession,false);
        bringToFront(caller);
    ...
    public void onInviteTrying(long sessionId) {
        ...
        Toast.makeText(MyApplication.this, "Call is trying...", Toast.LENGTH_SHORT).show();
    ...
    public void onInviteSessionProgress(long sessionId, String audioCodecs,
        ...
        Toast.makeText(MyApplication.this, "Call session progress.", Toast.LENGTH_SHORT).show();
    ...
    public void onInviteRinging(long sessionId, String statusText,
        ...
        Toast.makeText(MyApplication.this, "Ringing...", Toast.LENGTH_SHORT).show();
    ...
    public void onInviteFailure(long sessionId, String reason, int code) {
        ...
        Toast.makeText(MyApplication.this, "call failure" + reason, Toast.LENGTH_SHORT).show();
        tempSession.setDescriptionString("call failure" + reason);
        sendSessionChangeMessage("call failure" + reason, SESSION_CHANG);
        if(mCurrentActivity instanceof OutGoingActivity){
        ...
        if (tempSession.isReferCall()) {
            ...
            if (originSession != null) {
                ...
                Toast.makeText(MyApplication.this,"refer failure:" + reason
                        + "resume orignal call", Toast.LENGTH_SHORT).show();
    ...
    public void onInviteUpdated(long sessionId, String audioCodecs,
        ...
        Toast.makeText(MyApplication.this, "Call is updated", Toast.LENGTH_SHORT).show();
    ...
    public void onInviteConnected(long sessionId) {
        ...
        Toast.makeText(MyApplication.this, "Call is connected", Toast.LENGTH_SHORT).show();
    ...
    public void onInviteBeginingForward(String forwardTo) {
        Toast.makeText(MyApplication.this,"An incoming call was forwarded to: "
                + forwardTo, Toast.LENGTH_SHORT).show();
    ...
    public void onInviteClosed(long sessionId) {
        ...
        tempSession.reset();
        updateSessionVideo();
        Toast.makeText(MyApplication.this, ": Call closed.", Toast.LENGTH_SHORT).show();
    ...
    public void onRemoteHold(long sessionId) {
        ...
        Toast.makeText(MyApplication.this, "Placed on hold by remote.", Toast.LENGTH_SHORT).show();
    ...
    public void onRemoteUnHold(long sessionId, String audioCodecs,
        ...
        Toast.makeText(MyApplication.this, "Take off hold by remote.", Toast.LENGTH_SHORT).show();
    ...
    public void onRecvDtmfTone(long sessionId, int tone) {
        // TODO Auto-generated method stub
        Toast.makeText(MyApplication.this, "DTMF traferring.", Toast.LENGTH_SHORT).show();
...
//        sendSessionChangeMessage("the REFER was accepted.", SESSION_CHANG);
    ...
    public void setMainActivity(DashActivity mainActivity) {
...
//		ad.show();
    ...
    public void brignToDash() {
        try {
            if(mCurrentActivity instanceof MainActivity){
                mCurrentActivity.finish();
            }
            Intent startActivity = new Intent();
            startActivity.setClass(this, DashActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
...
//           .this.finish();
    ...
    public void bringToFront(String caller) {
        try {
            Intent startActivity = new Intent();
            startActivity.putExtra("caller2", "2");
            startActivity.setClass(this, IncomingActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity.putExtra("caller", caller);
            PendingIntent pi = PendingIntent.getActivity(this, 0, startActivity, 0);
            pi.send(this, 0, null);
        } catch (CanceledException e) {
            e.printStackTrace();
